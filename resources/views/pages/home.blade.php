...
@section('content')
    <section class="mb-8">
        ...
        <p class="md:text-lg text-gray-700">I currently work at <a href="https://surewise.com" class="text-brand-primary-500 underline font-medium">Surewise</a> where I build and maintain insurance systems.</p>
    </section>
    <section class="mb-8">
        <x-newsletter />
    </section>
