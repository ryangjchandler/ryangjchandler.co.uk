...
@section('body')
    ...
    <main>
        ...
        <section class="mb-8 md:mb-16">
            <h2 class="text-lg dark:text-gray-200 text-gray-700 mb-8">About Me</h2>
            <p class="leading-loose mb-4 dark:text-gray-300">
        ...
        <section>
            <h2 class="text-lg dark:text-gray-200 text-gray-700 mb-8">Latest Articles</h2>
            @forelse($posts->take(3) as $post) 
                @include('partials::_post-card')

                @if(! $loop->last)
                    <hr class="mb-8 dark:border-gray-600">
                @endif
            @empty
